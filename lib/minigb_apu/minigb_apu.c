...
static void __attribute__((unused)) update_env(struct chan *c)
{
...
static void __attribute__((unused)) update_len(struct minigb_apu_ctx *ctx, struct chan *c)
{
	if (!c->len.enabled)
		return;
...
static bool __attribute__((unused)) update_freq(struct chan *c, uint32_t *pos)
{
...
static void __attribute__((unused)) update_sweep(struct chan *c)
{
...
static uint8_t __attribute__((unused)) wave_sample(struct minigb_apu_ctx *ctx,
